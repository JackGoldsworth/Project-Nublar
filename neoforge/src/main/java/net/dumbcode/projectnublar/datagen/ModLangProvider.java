...
//        ItemInit.ITEMS.getEntries().forEach(this::itemLang);
    ...
    protected void itemLang(DeferredItem<Item> entry) {
        // 26.2: ItemNameBlockItem is gone (no ItemInit entry is a BlockItem anyway)
    ...
    protected String checkReplace(DeferredHolder<?, ?> entry) {
        return Arrays.stream(entry.getId().getPath().split("_"))
