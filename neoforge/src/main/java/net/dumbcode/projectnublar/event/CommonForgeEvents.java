...
public class CommonForgeEvents {
    ...
    @SubscribeEvent
    public static void onReloadListeners(AddServerReloadListenersEvent event) {
        event.addListener(Constants.modLoc("gene_data"), new GeneDataReloadListener());
        event.addListener(Constants.modLoc("behaviour_data"), new BehaviourDataReloadListener());
        event.addListener(Constants.modLoc("diet_data"), new DietReloadListener());
        event.addListener(Constants.modLoc("fossil_config"), new FossilConfigReloadListener());
    }
