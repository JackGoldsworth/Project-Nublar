...
public class SetWalkTargetToWaterSource<E extends Dinosaur> extends ExtendedBehaviour<E> {
    ...
    private static final Set<MemoryCondition<?, ?>> MEMORY_REQUIREMENTS = Set.of(
            new MemoryCondition.Present<>(MemoryModuleTypeInit.HAS_FOUND_WATER.get()),
            new MemoryCondition.Present<>(MemoryModuleTypeInit.IS_THIRSTY.get()));
    ...
    protected boolean checkExtraStartConditions(ServerLevel level, E entity) {
        this.target = BrainUtil.getMemory(entity, MemoryModuleTypeInit.HAS_FOUND_WATER.get());
